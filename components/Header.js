...
const Header = ()=>{
    ...
    const openMobileNav = ()=>{
        dispatch({type:mobileNavSliceActions.mobileNavStateHandler,payload:true})
    }
        ...
        >
            <Container>
                <Grid container>
                    ...
                    {!isMobile?<Grid item xs = {4} display = "flex" alignItems = "center" justifyContent = "space-between">
                    ...
                    <Grid display = "flex" alignItems = "center" justifyContent = "flex-end" item xs = {4}>
